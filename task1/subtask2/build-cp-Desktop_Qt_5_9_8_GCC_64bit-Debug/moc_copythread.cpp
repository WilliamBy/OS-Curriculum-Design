...
QT_MOC_LITERAL(1, 11, 4), // "rate"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 3), // "err"
QT_MOC_LITERAL(4, 21, 9) // "errhandle"

    },
    "CopyThread\0rate\0\0err\0errhandle"
};
...
void CopyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CopyThread::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CopyThread::rate)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CopyThread::err)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CopyThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CopyThread.data,
      qt_meta_data_CopyThread,  qt_static_metacall, nullptr, nullptr}
};
